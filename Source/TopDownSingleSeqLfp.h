#ifndef TOP_DOWN_SINGLE_SEQ_LFP_H
#define TOP_DOWN_SINGLE_SEQ_LFP_H
...
class TopDownSingleSeqLfp: public ILongestFlowPathAlgorithm, public ILongestFlowPathMultipleAlgorithm
{
  private:
